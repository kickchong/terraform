resource "aws_directory_service_directory" "sdc" {
...
resource "aws_vpc_dhcp_options" "this" {
  ...
  domain_name_servers  = aws_directory_service_directory.sdc.dns_ip_addresses
...
resource "aws_directory_service_conditional_forwarder" "qa_aws_local" {
  directory_id        = aws_directory_service_directory.sdc.id
